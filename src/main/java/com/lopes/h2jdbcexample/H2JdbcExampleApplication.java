package com.lopes.h2jdbcexample;
...
import com.lopes.h2jdbcexample.model.repository.EmployeeJDBCRepository;

@SpringBootApplication
public class H2JdbcExampleApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("Employee id 10011 -> {}", employeeRepository.findById(10011L).get());
	...
	public static void main(String[] args) {
		SpringApplication.run(H2JdbcExampleApplication.class, args);
	}
